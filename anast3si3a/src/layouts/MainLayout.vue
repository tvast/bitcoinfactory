...
<div class="q-px-lg q-pt-xl q-mb-md">
  <div class="text-subtitle">
          Another day on hearth : {{getDateNow}}
        </div>
      <div class="text-h3" to="/">
      
        AN3ST3SIA
         
      </div>
       <div class="text-subtitle">
            News agregator website for hacker, curious and open minded people
        </div>
        </div>
        <q-img class="header-image absolute-top" src="../assets/matrix.jpg"></q-img>
    </q-header>
      ...
      >
        <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
          <q-list padding>
            ...
            <q-item to="/about"active clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="list" />
              </q-item-section>
        ...
        <q-img class="absolute-top" src="../assets/matrix.jpg" style="height: 206px">
          <div class="absolute-bottom bg-transparent">
           
            <div class="text-weight-bold">The riot will be cyber</div>
            <div>join our telegram !</div>
             <q-avatar class="q-mb-sm">
               <a class="" href="https://t.me/joinchat/AAAAAFeNdCqgR8mspAFAPQ">           <div class=""><div>
